...
export default function Navbar2() {
    ...
    return (
        <Drawer>
            ...
            <DrawerItem
                label="Inbox"
                icon="https://www.iconpacks.net/icons/2/free-mail-inbox-icon-2572-thumb.png"
            ></DrawerItem>
            <DrawerItem
                label="Starred"
                icon="https://png.pngtree.com/png-clipart/20190924/original/pngtree-vector-star-icon-png-image_4869138.jpg"
            ></DrawerItem>
            <DrawerItem
                label="Send email"
                icon="https://www.iconpacks.net/icons/2/free-send-mail-icon-2574-thumb.png"
            ></DrawerItem>
            <DrawerItem
                label="Drafts"
                icon="https://cdn-icons-png.flaticon.com/512/46/46064.png"
            ></DrawerItem>
            <Line></Line>
            <DrawerItem
                label="All mail"
            ...
            <DrawerItem
                label="Trash"
                icon="https://cdn3.iconfinder.com/data/icons/linecons-free-vector-icons-pack/32/trash-512.png"
            ></DrawerItem>
            <Line></Line>
        </Drawer>
    );
